...
export function Input({ label, error, className, isPassword, ...props }: InputProps) {
  ...
  return (
    <View className={`w-full mb-lg ${className || ''}`}>
      ...
      <View className="relative justify-center">
        <TextInput
          className={`h-[56px] pl-lg pr-[48px] border font-app text-[16px] text-text-primary bg-background-surface ${
